            ...
            protected Void doInBackground() throws Exception {
                ...
                if (playerRed == null || playerBlue == null) {
                    ...
                    if (blue.converterToArrayUni() == null) {
                        ...
                        JOptionPane.showMessageDialog(principal, "Se registro la victoria "+ playerRed.getNombre());
                    } else {
                        conectar.registrarVictoria(playerBlue.getNombre(), playerBlue.getPassword());
                        JOptionPane.showMessageDialog(principal, "Se registro la victoria de "+ playerBlue.getNombre());
                    }
                }
