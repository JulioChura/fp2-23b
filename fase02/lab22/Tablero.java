...
public class Tablero {
    ...
    public Tablero(Army a, Army b, String kingdom1, String kingdom2) {
        army1 = a;
        army2 = b;
        chooseBattleField();
        ...
        for (int i = 0; i < a.size(); i++) {
            for (int j = 0; j < a.get(i).size(); j++) {
                if (a.get(i).get(j) != null) {
                    String strA = "|_" + charMap + "*" + Tablero.kingdom(kingdom1) + typSoldier(a.get(i).get(j))
        ...
        for (int i = 0; i < b.size(); i++) {
            for (int j = 0; j < b.get(i).size(); j++) {
                if (b.get(i).get(j) != null && map[i][j] != "s") {
                    String strB = "|_" + charMap + "*" + Tablero.kingdom(kingdom2) + typSoldier(b.get(i).get(j))
